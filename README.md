...
```bash
REPOSITORY                         TAG                 SIZE
blacktop/kibana-plugin-builder     latest              3.18GB
blacktop/kibana-plugin-builder     6.3.0               3.18GB
