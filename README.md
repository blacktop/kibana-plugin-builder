...
```bash
REPOSITORY                         TAG                 SIZE
blacktop/kibana-plugin-builder     latest              4.12GB
blacktop/kibana-plugin-builder     6.5.0               4.12GB
